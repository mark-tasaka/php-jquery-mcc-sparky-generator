...
<html>
<head>
<title>Launch Page: Sparky Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="sparkyForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Sparky, Level 1</option>
				<option value="02">Sparky, Level 2</option>
				<option value="03">Sparky, Level 3</option>
				<option value="04">Sparky, Level 4</option>
				<option value="05">Sparky, Level 5</option>
				<option value="06">Sparky, Level 6</option>
				<option value="07">Sparky, Level 7</option>
				<option value="08">Sparky, Level 8</option>
				<option value="09">Sparky, Level 9</option>
				<option value="10">Sparky, Level 10</option>
			  </select>
        ...
        {
            $("#sparkyForm").attr('action', "sparky/sparky"+ $("#level").val() +  ".php");
        });
